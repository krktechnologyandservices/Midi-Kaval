...
namespace MidiKaval.Api.Migrations
{
    ...
    [Migration("20260714012908_AddVisitPlaceCommentAndRemoval")]
    partial class AddVisitPlaceCommentAndRemoval
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MidiKaval.Api.Domain.Entities.BackupCode", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("MidiKaval.Api.Domain.Entities.BudgetLineItem", b =>
                {
                    ...
                    b.Property<DateTime?>("ThresholdNotifiedAtUtc")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("threshold_notified_at_utc");
            ...
            modelBuilder.Entity("MidiKaval.Api.Domain.Entities.VisitPlace", b =>
                {
                    ...
                    b.Property<DateTime?>("CommentUpdatedAtUtc")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("comment_updated_at_utc");

                    b.Property<Guid?>("CommentUpdatedByUserId")
                        .HasColumnType("uuid")
                        .HasColumnName("comment_updated_by_user_id");
