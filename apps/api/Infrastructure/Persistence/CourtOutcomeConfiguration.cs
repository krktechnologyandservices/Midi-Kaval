...
public sealed class CourtOutcomeConfiguration : IEntityTypeConfiguration<CourtOutcome>
{
    public void Configure(EntityTypeBuilder<CourtOutcome> builder)
    {
        builder.ToTable("legend_court_outcomes");
